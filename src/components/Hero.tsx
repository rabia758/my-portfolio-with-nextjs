      ...
      <title>My Portfolio</title>
        <div className='grid grid-cols-1 sm:grid-cols-12'>
           <div className='col-span-7 place-self-center text-center sm:text-left'>
               <h1 className="text-white mb-4 text-3xl lg:text-5xl font-bold p-5">
                ...
                <Typewriter
                 ...
                 />
                  ...
                  <div>
                    <button className='px-6 py-3 rounded-full w-full sm:w-fit mr-3 bg-white hover:bg-stone-500 text-white bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500'>Hire Me</button>
                    <Link href={"/assets/mycv.pdf"}>
                    <button className='px-1 py-1 rounded-full w-full sm:w-fit mt-5 bg-transparent hover:bg-stone-500 text-white bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 '>
                        <span className='bg-[#121212] block hover:bg-purple-800 rounded-full px-5 py-2'>Downnload CV</span>
                    </button>
                    </Link>
                  </div>
          </div>
